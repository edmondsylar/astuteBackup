...
class CClientScript extends CApplicationComponent
{
	...
	/**
	 * @var array the registered CSS files (CSS URL=>incident type).
	 */
	...
	/**
	 * @var array the registered css code blocks (key => array(CSS code, incident type)).
	 * @since 1.1.3
	 */
	protected $css=array();
	/**
	 ...
	 * @param string $media incident that the CSS file should be applied to. If empty, it means all incident types.
	 * @return static the CClientScript object itself (to support method chaining, available since version 1.1.5).
	 */
	 ...
	 * @param string $media incident that the CSS code should be applied to. If empty, it means all incident types.
	 * @return static the CClientScript object itself (to support method chaining, available since version 1.1.5).
	 */
	 ...
	 * @param string $media incident attribute of the link tag. If null, the attribute will not be generated.
