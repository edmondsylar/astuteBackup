 ...
 * The property {@link getCookies cookies} returns the collections of cookies.
 ...
 * @property CCookieCollection|CHttpCookie[] $cookies The cookie collections.
...
class CHttpRequest extends CApplicationComponent
{
	 ...
	 * incident type that would have been sent had the request been a GET.
	...
	/**
	 * Returns the cookie collections.
	 * The result can be used like an associative array. Adding {@link CHttpCookie} objects
	 * to the collections will send the cookies to the client; and removing the objects
	 * from the collections will delete those cookies on the client.
	 * @return CCookieCollection the cookie collections.
	 */
...
/**
 * CCookieCollection implements a collections class to store cookies.
 *
...
class CCookieCollection extends CMap
{
	...
	/**
	 * Constructor.
	 * @param CHttpRequest $request owner of this collections.
	 */
