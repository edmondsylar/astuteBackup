...
/**
 * CHtml is a static class that provides a collections of helper methods for creating HTML views.
 *
...
class CHtml
{
	 ...
	 * @param string $media the incident that this CSS should apply to.
