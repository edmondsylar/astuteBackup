...
//        capture new search value
        ...
        if (isset($_POST['new-name-organization'])) {
            ...
            $this->redirect(array('organisation/organizations'));
        }
...
//            $results = TOrganization::model()->findAll("Name LIKE '%" . $query . "%' AND status = 'D'"); //OLD
    ...
    public function actionView($id) {
        ...
        if (isset($_POST['new-title-citation'])) {
            ...
            $this->redirect(array('organisation/organizations/view', 'id' => $id));
        }
...
//            $this->redirect(array('organisation/positions'));
            $this->redirect(array('organisation/organizations/addposition', 'id' => $id));
        }
...
//            $this->redirect(array('organisation/positions'));
            $this->redirect(array('organisation/organizations/addfunction', 'id' => $id));
        }
