...
/**
 * This is the model class for table "a_intelligence_subscription".
 *
 * The followings are the available columns in table 'a_intelligence_subscription':
 ...
 */
class AIntelligenceSubscription extends CActiveRecord
{
	/**
	...
	{
		return 'a_intelligence_subscription';
	}
	 ...
	 * @return AIntelligenceSubscription the static model class
	 */
