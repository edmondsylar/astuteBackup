 ...
 */
class TAccess extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('userid, username, password, roles, status, role, userperm', 'required'),
			...
			array('id, userid, username, password, roles, status, role, userperm', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TAccess the static model class
	 */
