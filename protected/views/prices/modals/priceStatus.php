...
<div id="price_status<?php echo $record->serviceModulePriceUuid; ?>" class="modal" style="width: 350px;">
    <?php
    ...
    ?>
    <input  type="hidden" name="service-module-type-id" value="<?php echo $record->serviceModulePriceUuid; ?>">
    ...
    <div class="modal-content white" style="height: 115px;">
        ...
        <div class="modal-body">
            <p class="justify">You clicked on <code class="cyan-text"><?php echo $modules->serviceName; ?></code> and its current status is <code class="cyan-text"><?php echo $status; ?></code>
        </div>        
    </div>
