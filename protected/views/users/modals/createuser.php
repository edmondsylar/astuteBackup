...
<div id="createuser" class="modal" style="overflow: hidden; ">
<?php
  ...
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="username" id="weight_name" required="required">
        <label for="displayname" class="active">Name</label>
    </div>

    <div class="input-field col s12">
        <input type="text" name="usermail" id="weight_name" required="required">
