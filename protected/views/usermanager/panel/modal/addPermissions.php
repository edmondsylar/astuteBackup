<div id="add-permissions" class="modal modal-fixed-footer" style="border-radius: 5px;">
    <?php
    ...
    <div class="modal-content white">
        <h4 style="text-transform: capitalize;"> New Permission
            <div class="divider"></div>
        </h4>
        <div class="row s12">
        <div class="row s12">
            <div class="input-field col s12">
                <input placeholder="....." name="permission" type="text" required>
                <label>Permission  <span class="red-text"> *</span></label>
            </div>
        </div>
        <div class="row s12">
            <div class="input-field col s12">
                <label for="editor" class="active">Permission Description <span class="red-text">*</span></label>&nbsp;&nbsp;
                <textarea id="editor" name="permission-description" placeholder="Enter text Here." required="required"></textarea>
            </div>
        </div>
        </div>
    </div>
