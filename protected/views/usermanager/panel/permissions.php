                            ...
                            <div class="col s12 m3 16 ">                                
                                <ul class="tabs">
                                    <li class="tab col s10" style="text-align: left">
                                        <span class="grey-text" style="font-size: 12px; text-transform: capitalize;">Permissions Available</span>
                                    </li> 
                                </ul>
                            </div>
                        </div>
        ...
        <div class="col s12 m12 l12">
            <div class="search-page-results">
                <div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right: 24px;">
                    ...
                    <ul>
                            <li><a class="btn-floating blue modal-trigger tooltipped" href="#add-permissions" data-position="top" data-delay="50" data-tooltip="Add Permission"><i class="material-icons">description</i></a></li>
                    </ul>
                </div>
                <!--###############################-->
                ...
                <div class="card">
                    <div class="card-content">   
                        <?php
                        //permissions
                        include_once 'modal/pagePermissions.php';
                        ?>
...
<?php
//add permissions
include 'modal/addPermissions.php';
?>