...
<div id="addorganizationtoincident<?php echo $organization_idd; ?>" class="modal" style="width: 800px;">
    <?php
    ...
    <input type="hidden" name="organization_id" value="<?php echo $organization_unique_id; ?>">
    <input type="hidden" name="uid" value="<?php echo $incident->incidentUuid; ?>">
    <!--<div class="row s12 white">-->
    <div class="modal-content ">
        <p class="grey-text text-darken-4">New Organization</span> </p>
            <code>Add Organization with Name </code> <span class="black-text"> <?php echo $organizationname; ?></span>
