...
<div id="addpositiverole" class="modal modal-footer" style="width: 450px;">
    <?php
    ...
    <div class="modal-content white">
        ...
        <span>Positive Role : </span>
        <div class="row s12">
            <div class="input-field col s12">
                    <div class="input-field col s12" required="required">
                        <input placeholder="....." id="label" name="new-positive-role" type="text" required="required">
                        <label for="label" class="active">New Positive Role </label>
                    </div>
            </div>
        </div>
    </div>
