<div id="deleteperson<?php echo $result->id; ?>" class="modal"  >
    <?php
    ...
    <div class="modal-content" style="height: 140px;background-color: ghostwhite;">
        ...
        <span class="grey-text"><span class="black-text"><?php echo $personName; ?></span> <code> From Incident with title </code> <span class="black-text"><?php echo $incidents->incidentTitle; ?></span>
        </span>
    </div>
