...
<div id="intell" class="modal modal-fixed-footer">
<?php
...
<div class="modal-content">
  <h4>Create intelligence categorie</h4>
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="intelcat" id="displayname" required="required">
        <label for="displayname" class="active">intelligence categorie Name</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="Intelldec" placeholder="Enter Intelligence categorie Description Here."></textarea>
      </div>
    </div>
  </div>
</div>
