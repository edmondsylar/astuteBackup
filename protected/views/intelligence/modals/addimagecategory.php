...
<div id="imagecat" class="modal" style="border-radius: 5px;">
<?php
...
<div class="modal-content">
  <h4>Create Image Category</h4>
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="imagecatname" id="weight_name" required="required" autofocus>
        <label for="displayname" class="active">Add Image Category Name</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="imagecatdesc" placeholder="Enter weight Description Here."></textarea>
      </div>
    </div>
  </div>
</div>
