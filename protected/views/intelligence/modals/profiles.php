...
<div id="ptypemodle" class="modal modal-fixed-footer">
<?php
...
<div class="modal-content">
  <h4>Create Profile type</h4>
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="profname" id="displayname" required="required">
        <label for="displayname" class="active">Profile Name</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="dec" placeholder="Enter Term Description Here."></textarea>
      </div>
    </div>
  </div>
</div>
