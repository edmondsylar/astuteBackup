<div id="coutryEdit<?php echo $record->countryUuid;  ?>" class="modal" style="width: 400px; height: auto; border-radius: 5px;">
    <?php
      ...
      <div class="card-content" style="margin: 10px;">
        <span class="card-title">Edit Country</span><span class="right">
          <form class="" action="index.html" method="post">
            <input type="text" name="deletingCountry" value="<?php echo $record->profileUuid; ?>" style="display: none;">
            <input type="text" name="deletingCountryPro" value="<?php echo $record->countryUuid; ?>" style="display: none;">
            <input type="text" name="deletingCountryType" value="<?php echo $record->countryTypeUuid; ?>" style="display: none;">
        ...
        <label for="<?php echo $record->profileUuid; ?>" style="margin-top: 10px;">Select Country</label>
        <input type="hidden" name="editProfilename" value="<?php echo $record->profileUuid; ?>">
        ...
        <option value="<?php echo $record->countryUuid ?>" selected> <?php
            $country = TCountry::model()->findByAttributes(array("id"=>$record->countryUuid));
            echo $country['name'];
           ?>
         </option>
            <?php
