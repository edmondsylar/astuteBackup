...
<div id="weight" class="modal" style="border-radius: 5px;">
<?php
  ...
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="weight_name" id="weight_name" required="required">
        <label for="displayname" class="active">Add weight Name</label>
      </div>
      <div class="input-field col s12">
        <input type="number" name="weight" id="weight" required="required">
        <label for="displayname" class="active">Add weight</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="weightdec" placeholder="Enter weight Description Here."></textarea>
      </div>
    </div>
  </div>
</div>
