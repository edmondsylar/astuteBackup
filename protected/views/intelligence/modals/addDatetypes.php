...
<div id="dates" class="modal" style="border-radius: 5px;">
<?php
...
<div class="modal-content">
  <h4>Create Date Type</h4>
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="datetypename" id="weight_name" required="required" autofocus>
        <label for="displayname" class="active">Add Date Type Name</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="datedesc" placeholder="Enter Date type Description Here."></textarea>
      </div>
    </div>
  </div>
