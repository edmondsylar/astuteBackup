...
<div id="refrence" class="modal" style="border-radius: 5px;">
<?php
...
<div class="modal-content">
  <h4>Create Reference Type</h4>
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="refname" id="weight_name" required="required" autofocus>
        <label for="displayname" class="active">Add Reference Type</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="refdesc" placeholder="Enter Reference Type Description Here."></textarea>
      </div>
    </div>
  </div>
</div>
