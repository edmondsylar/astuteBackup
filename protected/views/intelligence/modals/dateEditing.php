...
<div id="dateEditor<?php echo $record->profileDateUuid; ?>" class="modal" style="width: 450px;">
    <?php
    $del = "X";
  ...
  <div class="card-content" style="margin: 10px;">
    ...
    <span class="right">
      <form class="" action="index.html" method="post">
        <input type="text" name="deletingRecord" value="<?php echo $record->profileUuid; ?>" style="display: none;">
        <input type="text" name="deletingDate" value="<?php echo $record->date; ?>" style="display: none;">
    ...
    <div class="row">
        <div class="input-field col s12">
          <i class="material-icons prefix">date_range</i>
            ...
            <label for="birthdate"><?php echo $record->date; ?></label>
            <input id="birthdate" type="text" class="datepicker" name="changedate">
            <input type="hidden" name="changedated" value="<?php echo $record->profileDateUuid; ?>">
            <input type="text" name="editDateType" value="" id="dateTypeNew" required style="display: none;">
            <input type="text" name="profile" value="<?php echo $record->profileUuid; ?>" required style="display: none;">
        </div>
