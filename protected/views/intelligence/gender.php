...
if(!empty($find->updatedBy))
{
         ...
         <div class="col s12 m12 l12">
             <div class="search-page-results">
                 <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                     <a class="btn-floating btn-small blue waves-effect modal-trigger tooltipped" href="#gender"  data-position="left" data-delay="50" data-tooltip="Create profile Type">
 ...
 <?php
   include_once 'modals/addgender.php';
  ?>
