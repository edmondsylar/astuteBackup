...
if(!empty($find->updatedBy))
{
         ...
         <div class="col s12 m12 l12">
             <div class="search-page-results">
                 <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                     <a class="btn-floating btn-small blue waves-effect modal-trigger tooltipped" href="#imagecat"  data-position="left" data-delay="50" data-tooltip="Create profile Type">
                         ...
                         <table id="example" class="display responsive-table datatable-example">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td><?php echo $item->imageCategory; ?></td>
                                     <?php
                                       if($item->status = 'A'){
                                         ?>
                                         ...
                                         // code...
                                          ...
                                          ?>
                                    <td><?php echo date_format(date_create($item->updatedOn), "d / M / Y"); ?></td>
                                     <td><?php
 ...
 <?php
   include_once 'modals/addimagecategory.php';
  ?>
