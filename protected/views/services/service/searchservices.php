...
$searched = $model[1];
$services = TServices::model()->findAll("status IN ('A','C','D')");
?>
                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 12px">
                                    <div class="breadcrumbs">
                                        <?php echo CHtml::link('services', array('services/service')); ?> &sol;
                                    </div>
                                </h5>
                            </div>
                        </div>
                            ...
                            <div class="col s12 m6 l6">
                                <ul class="tabs">
                                    <li class="tab col s6" style="text-align: left">
                                        <span class="grey-text" style="font-size: 14px; text-transform: none;">Search for Service </span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
//                                            $createdon = $result->createdon;
                                ...
                                <div class="row s12 right" >
                                    <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                          <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=services/searchservices'" name="result" class="with-gap">
