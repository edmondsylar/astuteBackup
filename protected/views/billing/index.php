                        ...
                        <div class="row search-tabs-row search-tabs-header">
                            <div class="col s12 m6 16 search-stats">
                                <ul class="tabs">
                                    <li class="tab col s10" style="text-align: left">
                                        <span class="grey-text" style="font-size: 14px;  text-transform: none;">Billing </span>&nbsp;&nbsp;<span class="black-text" style="font-weight: 300;">
                                    </li>
                                </ul>
                            </div>
                            <div class="col s10 m6 l6 right-align" style="margin-top: 5px;">&nbsp;
                                ...
                                <ul id='dropdown2' class='dropdown-content2'>
                                    ...
                                    <li class="droped"><a style="color: black; font-weight: 400;" href="<?php echo $this->createUrl('billing/intel_and_price&Uid='.$roleUuid); ?>"><span>Price List</span></a>
                                    </li>
        ...
        <div class="col s12 m12 l12">
            <div class="search-page-results">
                ...
                <!-- <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                    <a class="btn-floating btn-small blue waves-effect modal-trigger tooltipped" href="#add-business"  data-position="left" data-delay="50" data-tooltip="Create New billing Scheme">
                    ...
                    <div class="card-content ">
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            <?php 
                                if(!empty($info)){
                                        $count = 0;
                                    foreach($info as $bill){
                                        $count++;
                                        ?>
                                        <tr onclick="location.href = '<?php echo $this->createUrl('billing/invoice&Uid='.$roleUuid.'&id='.$bill->subscriptionUuid); ?>'">
                                            <td><?php echo $count ?></td>

                                            <td><?php echo $bill->businessUuid; ?></td>
                                            <td><?php echo $bill->placedBy; ?></td>
                                            <td><?php echo $bill->total; ?></td>
                                            <td><?php echo $bill->placedOn; ?></td>
