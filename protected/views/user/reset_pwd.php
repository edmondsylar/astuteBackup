            ...
            <div class="card white darken-1 z-depth-5">
                <div class="card-content ">
                    <h4 class=" grey-text" style="font-family: sans-serif; text-align: center">
                        astute </h4>
                    <span class="card-title"> <i class="material-icons">person_pin</i> <?php echo $model[2]; ?> </span>
                    <div class="row">
                        <!--<form class="col s12">-->
                        <?php
                        ...
                        ?>
                            <input type="hidden" name="reset-pwd" value="true">
                         
                            <div class="col s12">
                                <p style="font-size: 12px;text-align: justify;">An email with a password reset code was just sent to your recovery email address.</p>
                                <br/>
                            </div> 
                            <div class="input-field col s12">
                                <input placeholder="....." name="code" type="text" value="<?php if($model[1] != NULL){ echo $model[1]; }?>" class="cyan-text" maxlength="9" autocomplete="off" autofocus required>
                                <label>Enter Code </label>
                            </div> 
                            <div class="col s12 right-align m-t-sm">
                                <a href="#cancelReset" class="waves-effect waves-grey btn-flat modal-trigger left cyan-text" style="text-transform: capitalize;">Cancel</a>
                                <button type="submit" class="waves-effect waves-blue btn cyan ">Next</button>
                            </div>                        
                        <?php $this->endWidget(); ?>
                        <!--</form>-->
                    </div>
