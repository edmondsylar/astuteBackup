<?php
  $uid = $_GET['s_uid'];
  $permissions = AcPermissions::model()->findAll();

  include_once 'modals/addperm.php';
?>
<style media="screen">
  .search-bar-form{
    position: absolute;
...
<div class="z-depth-1 search-tabs">
 <div class="search-tabs-container">
          ...
          <div class="col s12 m6 16 search-stats">
              <ul class="tabs">
                  <li class="tab col s10" style="text-align: left">
                      <span class="grey-text" style="font-size: 14px; text-transform: none;"> <b>Users > Permissions</b>
    ...
    <div class="card-content invoice-relative-content search-results-container" style="position: fixed; z-index: -1;">
        <div class="col s12 m12 l12">
                    ...
                    <div class="card-content ">
                        <table id="example" class="display responsive-table datatable-example">
                            ...
                            <tr>
                                ...
                                <th style="width: 250px;">Permission Uuid</th>
                                  ...
                                  foreach ($permissions as $perm ) {
                                    ...
                                    ?>
                                      <tr>
                                        ...
                                        <td><?php echo $perm->permissionUuid; ?></td>
                                        <td><?php echo $perm->name; ?></td>
                                        <td><?php echo $perm->type; ?></td>
                                        <td><?php echo $perm->status; ?></td>
                                        <td><?php echo date_format(date_create( $perm->updatedOn), "d / F / Y"); ?></td>
                                      </tr>
                                    <?php
                                  }
                                }
      ...
      <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
          <a class="btn-floating btn-small black waves-effect modal-trigger tooltipped" href="#permissionAdd"  data-position="left" data-delay="50" data-tooltip="Create Permission">
