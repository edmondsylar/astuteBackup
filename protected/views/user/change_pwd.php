            ...
            <div class="card white darken-1 z-depth-5">
                <div class="card-content ">
                    <h4 class=" grey-text" style="font-family: sans-serif; text-align: center">
                        astute </h4>
                    <span class="card-title"> <i class="material-icons">person_pin</i> <?php echo $model[1]; ?> </span>
                    <div class="row">
                        <!--<form class="col s12">-->
                        <?php
                        $model=new LoginForm;
                        ...
                        ?>
                            ...
                            <input type="hidden" name="change-pwd" value="true">
                         
                            <div class="input-field col s12">
                                <input placeholder="....." name="new-password" type="password" class="cyan-text" autocomplete="off" autofocus required>
                                <label>New Password </label>
                            </div> 
                            <div class="input-field col s12">
                                <input placeholder="....." name="confirm-password" type="password" class="cyan-text" autocomplete="off" required>
                                <label>Confirm Password </label>
                            </div> 
                            <div class="col s12 right-align m-t-sm">
                                <a href="#cancelChange" class="waves-effect waves-grey btn-flat modal-trigger left cyan-text" style="text-transform: capitalize;">Cancel</a>
                                <button type="submit" class="waves-effect waves-blue btn cyan ">Reset</button>
                            </div>
                        <?php $this->endWidget(); ?>
                        <!--</form>-->
                    </div>
...
<?php
//cancel
include_once 'pages/cancelChange.php';
?>
<!-- Javascripts -->
