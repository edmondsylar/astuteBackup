...
//                                            nationality name
                                            ...
                                            ?>
                                            <span class="row s12" onclick="location.href = '<?php echo Yii::app()->baseUrl; ?>/index.php?r=organisation/organizations/view&id=<?php echo $code->encode($result->id); ?>'">
                                    ...
                                    <div class="row s12 right" >
                                        <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                                <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=organisation/organizations/search'" name="result" class="with-gap">
