                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">                                    
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Functions', array('organisation/functions')); ?> &sol;
...
//                                            position name
                                    ...
                                    <div class="row s12 right" >
                                        <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                                <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=organisation/functions/search'" name="result" class="with-gap">
