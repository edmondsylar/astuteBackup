                                ...
                                <ul class="tabs">
                                    <li class="tab col s12" style="text-align: left">
                                        <span class="grey-text text-darken-4"> 
                                            <small class="grey-text">Author</small> - <?php echo $incident->authors; ?>
                                            <small class="grey-text">Title</small> - <?php echo $incident->title; ?>
                                            <small class="grey-text">Page</small> - <?php echo 'Page_' . $incident->page; ?>
                                        </span> 
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <tbody> 
                                            ...
                                            if (!empty($results)) {
                                                ...
                                                foreach ($results as $record) {
                                                    ...
                                                    $person_exist = TAdversemediaPeople::model()->findAll("adversemedia = '$adversemedia_id' and person = '$person_unique_id' and status IN ('D','A')");
                                                    ?>
