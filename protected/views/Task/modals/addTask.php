...
<div id="addTask" class="modal" style="border-radius: 5px;">
<?php
  ...
  <div class="row">
    <div class="row">
      <div class="input-field col s12">
        <input type="text" name="taskname" id="taskname" required="required" autofocus>
        <label for="taskname" class="active">Add Task</label>
      </div>
      <div class="input-field col s12">
        <textarea id="editor" name="description" placeholder="Enter text Here."></textarea>
      </div>
    </div>
  </div>
</div>
