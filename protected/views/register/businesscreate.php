                ...
                <div class="card-content ">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12">
                            <label>Business Name <span class="red-text">*</span></label><br>
                            <input type="text" name="business-name" autoFocus required>
                            
                        </div>

                        <div class="input-field col s12">
                            <label>Business Type <span class="red-text">*</span></label><br>
                            <select id="el" name="business-type" style="position: absolute; width: 100%;" required>
                            <option value="" active selected>Choose...</option>
                                <?php
                        ...
                        <div class="input-field col s12">
                            <label>Country <span class="red-text">*</span></label><br>
                            ...
                            <div class="col s12 right-align m-t-sm">
                                <button class="waves-effect waves-blue btn blue right"><?php echo CHtml::submitButton('Complete Register'); ?></button>
                            </div>                        
                        <?php $this->endWidget(); ?>
                        <!--</form>-->
                    </div>
