...
<!--    <script src="assets/js/pages/uikit.min.js"></script>-->
<!--    <script src="assets/js/pages/uikit-icons.min.js"></script>-->
...
<body class="grey lighten-5" oncontextmenu="return false" onkeypress="return disableCtrlKeyCombination(event);" onkeydown="return disableCtrlKeyCombination(event);" ondragstart="return false;" ondrop="return false;">
...
<div class="mn-content valign-wrapper">
    <main class="mn-inner container">
        <div class="valign">
            <div class="row">
                <div class="col s13 m6 l5 offset-l4 offset-m3">
                    ...
                    <div class="card z-depth-1">
                        <div class="card-content"style="margin-left: 10px;">
                            <h4 class=" grey-text" style="font-family: sans-serif; text-align: center">
                                ASTUTE </h4>
                            <div class="card-title" style="text-align: center;">Terms and Conditions</div>
                <?php
...
<!--                <form class="uk-form-stacked" id="wizard_advanced_form">-->
                <input type="hidden" name="RegisterTermForm" id="wizard_fullname" value="true" />
                    <div id="wizard_advanced">
                        <!-- first section -->
                        <section>
                            <p style="text-align: center;">
                                Read and Astute to the Terms and Conditions
                            </p>
                            <script>
...
<!--                            <div data-dynamic-fields="d_field_wizard" class="uk-grid" data-uk-grid-margin></div>-->
                            <form action="" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the Terms and Conditions and Privacy Policy'); return false; }">
                                <?php
                                        $terms = TTermsOfServiceVersionTerms::model()->findAll("status = 'A'");

                                        foreach ($terms as $t)
                                        {

                                            $active_terms_title = $t->title;
                                            $active_terms_description = $t->content;
                                            ...
                                            <div class="row">
                                                <div style="margin-left: 10px;">
                                                    ...
                                                    <label class="black-text" style="font-size: 14px;"><?php echo $active_terms_title; ?></label>
                                                    </div>
                                                        <p id="auto">
                                                        <?php echo $active_terms_description; ?>
                                                         </p>
                                                </div>
                                            </div>
                                <?php
                                ...
                                ?>
                                <hr>
                                <input type="checkbox" name="checkbox" value="check" id="agree"  style="width: 0px;"/><label for="agree"> I have read and agree to the Terms and Conditions and Privacy Policy </label><br><br>
