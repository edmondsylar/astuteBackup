                    ...
                    <div class="card z-depth-1">
                        <div class="card-content"style="margin-left: 10px;">
                            <h4 class=" grey-text" style="font-family: sans-serif;">
                                astute </h4>
                            <div class="card-title">Verify your email address <i class="material-icons">person_pin</i> <?php echo $model[2]; ?></div>
                <?php
                        ...
                        <section>
                            ...
                            <?php 
                                if(isset($_GET['email'])){
                                    $email = $_GET['email']
                                    ?>
                               Enter Verification Code sent to <span class="blue-text"><?php echo $email?></span>  from Astute
                               <?php 
                                }
                            ?>
                            </p><br>
<!--                            <div data-dynamic-fields="d_field_wizard" class="uk-grid" data-uk-grid-margin></div>-->
                            <div class="input-group">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text"  name="code" id="code" required  value="<?php if($model[1] != NULL){ echo $model[1]; }?>" class="cyan-text" maxlength="9"  />
                                </div>
                            </div>
