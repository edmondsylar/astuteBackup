                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">                                    
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Adverse Media Programs', array('settings/panel/adversemediaprogram')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                <?php if ($results != '') { ?><label for="record" class="active">Searched Program Name </label><br>
                                    <?php } else{?>
                                <label for="record" class="active">Enter Program Name <span class="red-text">*</span></label><br>
                                <?php }?>
...
//                                            $createdon = $result->createdon;
                                    ...
                                    <div class="row s12 right" >
                                        <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                                <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settings/panel/searchprogram'" name="result" class="with-gap">
                                                <label for="Match"> Match</label>&nbsp; &nbsp; &nbsp; &nbsp;
                                                <input type="radio" id="No Match"  href="#createadverseprogram" name="result" class="with-gap modal-trigger">
...
include_once 'modals/createadverseprogram.php';
?>
