                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Intelligence ', array('settings/panel/intelligence')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                ?>
                                <input type="text" name="newquery3" required="required" id="record" placeholder="....." value="<?php echo $searched; ?>"><br>
                                <?php if ($results != '') { ?><label for="record" class="active">Searched Intelligence Name </label><br>
                                <?php } else{?>
                                    <label for="record" class="active">Enter Intelligence Name <span class="red-text">*</span></label><br>
                                <?php }?>
...
//                                            position name
                                    $position = $result->intelligence_name;
                                    $status = $result->intelligence_category_status;
//                                            $createdon = $result->createdon;
                                ...
                                <div class="row s12 right" >
                                    ...
                                    <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settings/panel/searchintelligence'" name="result" class="with-gap">
                                    <label for="Match"> Match</label>&nbsp; &nbsp; &nbsp; &nbsp;
                                    <input type="radio" id="No Match"  href="#create-intelligence" name="result" class="with-gap modal-trigger">
...
include_once 'modals/createintelligence.php';
?>
