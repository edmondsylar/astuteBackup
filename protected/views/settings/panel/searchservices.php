...
$searched = $model[1];
$business = TBusiness::model()->findAll("status IN ('A','C','D')");
?>
                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Panel', array('settings/panel/services')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                ?>
                                <input type="text" name="newquery5" required="required" id="record" placeholder="....." value="<?php echo $searched; ?>"><br>
                                <?php if ($results != '') { ?><label for="record" class="active">Searched Service Name </label><br>
                                <?php } else{?>
                                    <label for="record" class="active">Enter Service Name <span class="red-text">*</span></label><br>
                                <?php }?>
...
//                                            $createdon = $result->createdon;
                                ...
                                <div class="row s12 right" >
                                    <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                          <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settings/panel/searchservices'" name="result" class="with-gap">
                                            <label for="Match"> Match</label>&nbsp; &nbsp; &nbsp; &nbsp;
                                            <input type="radio" id="No Match"  href="#createservices" name="result" class="with-gap modal-trigger">
