...
$searched = $model[1];
//$create1 = $model[2];
$service = TServiceCreate::model()->findAll("status IN ('A','C','D')");
                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Panel', array('settings/panel/servicemodules')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                ?>
                                <input type="text" name="newquery6" required="required" id="record" placeholder="....." value="<?php echo $searched; ?>"><br>
...
//                                            position name
                                    $businessUuid = $result->businessUuid;
