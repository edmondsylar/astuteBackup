                                ...
                                <div class="col s12 m6 16">
                                    <ul class="tabs">
                                        <li class="tab col s10" style="text-align: left">
                                            <span class="grey-text" style="font-size: 14px;">New Service </span>&nbsp;&nbsp;<span class="red circle white-text">&nbsp;&nbsp;<?php echo count($create); ?>&nbsp;&nbsp;</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="col s12 m12 l12">
                <div class="search-page-results">
                    <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                        <!--href="#createposition"-->
                        <a  href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settings/panel/searchservices" class="btn-floating btn-large waves-effect tooltipped"  data-position="left" data-delay="50" data-tooltip="Create Service" >
