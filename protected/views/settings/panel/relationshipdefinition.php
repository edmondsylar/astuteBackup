                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        ...
                                        <span>Relationship Definitions</span>
                                    </div>
                                </h5>
                            </div>
                        </div>
                            ...
                            <div class="col s12 m6 16">
                                <ul class="tabs">
                                    <li class="tab col s10" style="text-align: left">
                                        <span class="grey-text" style="font-size: 14px;">Relationship Definitions</span>&nbsp;&nbsp;<span class="red circle white-text">&nbsp;&nbsp;<?php echo count($model); ?>&nbsp;&nbsp;</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="col s12 m12 l12">
                <div class="search-page-results">
                    <div class="fixed-action-btn horizontal click-to-toggle" style="bottom: 45px; right: 24px;">
                        ...
                        <ul>
                            <li><a class="btn-floating indigo modal-trigger tooltipped "  href="#createrelationship" data-position="top" data-delay="50" data-tooltip="Create Relationship"><i class="material-icons">people</i></a></li>
                        </ul>
                    </div>
...
//                                        $types = TOrganizationtype::model()->findAll("$type_id IN ($ids)");
                                        ...
                                        <tr >
                                            ...
                                            <td ><a class="<?php echo $color; ?> modal-trigger" href="#relationshipstatus<?php echo $record->id; ?>" onmouseover="this.style.color = 'orange';"  onmouseout="this.style.color = '';"><?php echo $status; ?></a></td>
                                        ...
                                        include 'modals/relationshipstatus.php';
                                        include 'modals/deleterelationship.php';
                                        include 'modals/editrelationship.php';
                                    }
                                    ?>
                                <?php } else{ } ?>
                                </tbody>
...
<?php
    ...
    include_once 'modals/createrelationship.php';
