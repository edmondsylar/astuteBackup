                        ...
                        <div class="row">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input type="text" name="versionName" id="displayname" required="required">
                                        <label for="displayname" class="active">Term Heading</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <input type="text" name="status" id="displayname" required="required">
                                        <label for="displayname" class="active">Status</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <textarea id="editor" name="versionDescription" placeholder="Enter Terms Description"></textarea>
                                    </div>
                                </div>
                        </div>
                    </div>
