                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        ...
                                        <?php echo CHtml::link('Intelligence Categories', array('settings/panel/intelligencecategories')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                <?php if ($results != '') { ?><label for="record" class="active">Searched Category Name </label><br>
                                <?php } else{?>
                                    <label for="record" class="active">Enter Category Name <span class="red-text">*</span></label><br>
                                <?php }?>
...
//                                            $createdon = $result->createdon;
                                ...
                                <div class="row s12 right" >
                                    ...
                                    <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=settings/panel/searchcategory'" name="result" class="with-gap">
                                    <label for="Match"> Match</label>&nbsp; &nbsp; &nbsp; &nbsp;
                                    <input type="radio" id="No Match"  href="#createintelligencecategory" name="result" class="with-gap modal-trigger">
...
include_once 'modals/createintelligencecategory.php';
?>
