                    ...
                    <div class="col s12 m12 l12">
                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">
                                    <div class="breadcrumbs">
                                        <span class="black-text">People</span>
                        ...
                        <div class="row search-tabs-row search-tabs-container grey lighten-4">
                            ...
                            <div class="col s12 m6 l6 right-align" style="margin-top: 7px;">
                                <input type="button" class=" waves-blue btn-flat" value="View Pending Positions" onclick="window.open('<?php echo @Yii::app()->baseUrl; ?>/index.php?r=people/politicallyExposed/viewpendingwork', 'popup', 'height=400,width=1000,left=5,top=10,scrollbars=yes,menubar=no titlebar'); return false;"
        ...
        <div class="col s12 m12 l12">
            <div class="search-page-results">
                ...
                <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                    <a class="btn-floating btn-large red waves-effect tooltipped "  href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=people/politicallyExposed/search" data-position="left" data-delay="50" data-tooltip="Create New Person" >
                            ...
                            <tbody>
                                ...
                                if (!empty($people)) {
                                    ...
                                    foreach ($people as $record) {
                                        ...
                                        <tr onclick="location.href = '<?php echo Yii::app()->baseUrl; ?>/index.php?r=people/politicallyExposed/view&id=<?php echo $code->encode($record->person_id); ?>'">
                                        <?php } else { ?>
                                        <tr>
                                        <?php } ?>
                                            <td><?php echo $r; ?>.</td>
