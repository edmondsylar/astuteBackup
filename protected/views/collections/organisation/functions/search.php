                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">                                    
                                    <div class="breadcrumbs">
                                        <span class="black-text">Functions</span> &sol;
                                        <?php echo CHtml::link('Functions', array('collections/organisation/functions')); ?> &sol;
                    ...
                    <div class="card-content">
                        <div class="row s12">
                            ...
                            <div class="col s6 input-field">
                                ...
                                <?php if ($results != '') { ?><label for="record" class="active">Searched Function Name </label><br>
                                    <?php } else{?>
                                <label for="record" class="active">Enter Function Name <span class="red-text">*</span></label><br>
                                <?php }?>
...
//                                            position name
                                            ...
                                            <span class="row s12">
                                                ...
                                                <div class="col s3"><span>Status</span> &rtrif; <span class="<?php echo $color;?>"><?php echo $name; ?></span></div>
                                    ...
                                    <div class="row s12 right" >
                                        <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                                <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=collections/organisation/functions/search'" name="result" class="with-gap">
                                                <label for="Match"> Match</label>&nbsp; &nbsp; &nbsp; &nbsp;
                                                <input type="radio" id="No Match"  href="#createfunction" name="result" class="with-gap modal-trigger">
...
include_once 'modals/createFunction.php';
?>
