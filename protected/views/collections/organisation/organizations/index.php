            ...
            <div class="search-page-results">
                ...
                <div id="draft">
                    <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                        ...
                        <a class="btn-floating btn-large waves-effect tooltipped "  href="<?php echo @Yii::app()->baseUrl; ?>/index.php?r=collections/organisation/organizations/search" data-position="left" data-delay="50" data-tooltip="Add" >
                    ...
                    <?php if (!empty($model)) { ?>
                                ...
                                foreach ($model as $record) {
                                    ...
                                    ?>
                                    <tr onclick="location.href = '<?php echo Yii::app()->baseUrl; ?>/index.php?r=collections/organisation/organizations/view&id=<?php echo $code->encode($record->id); ?>'">
                                        <td><?php echo $t.'. '?></td>
...
<?php
//add organization
//include_once 'modal/addOrganization.php';
?>
