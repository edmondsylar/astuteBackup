                            ...
                            <div class="col s12 m12 l10 left">
                                <h5 class="" style="font-size: 14px">                                    
                                    <div class="breadcrumbs">
                                        <span class="black-text">Positions</span> &sol;
                                        <?php echo CHtml::link('Position', array('collections/organisation/positions')); ?> &sol;
...
//                                            position name
                                    ...
                                    <div class="row s12 right" >
                                        <input type="hidden" name="newname" value="<?php echo $searched; ?>">
                                                <input type="radio" id="Match" onclick="location.href='<?php echo @Yii::app()->baseUrl; ?>/index.php?r=collections/organisation/positions/search'" name="result" class="with-gap">
